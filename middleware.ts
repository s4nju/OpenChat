...
export async function middleware(request: NextRequest) {
  ...
  response.headers.set(
    ...
    isDev
      ...
      : `default-src 'self'; script-src 'self' 'unsafe-inline' 'wasm-unsafe-eval' https://cdnjs.cloudflare.com https://chat.ajanraj.com https://vercel.live https://umami.ajanraj.com; frame-src 'self' https://vercel.live; style-src 'self' 'unsafe-inline'; img-src 'self' data: https: blob:; connect-src 'self' wss: https://api.openai.com https://api.mistral.ai https://api.supabase.com ${supabaseDomain} ;`
  )
