...
export const REASONING_FEATURE        = { id: "reasoning-full",    enabled: true,  supportsEffort: true,  label: "Supports reasoning capabilities" }
export const REASONING_FEATURE_BASIC  = { id: "reasoning-basic",   enabled: true,  supportsEffort: false, label: "Supports reasoning capabilities" }
export const REASONING_FEATURE_DISABLED = { id: "reasoning-none",  enabled: false, label: "Supports reasoning capabilities" }
