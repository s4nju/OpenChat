...
export function ChatHeader({
  ...
  return (
    <div className="flex w-full items-center justify-between pt-2 pl-[calc(0.5rem+env(safe-area-inset-left))] pr-[calc(0.5rem+env(safe-area-inset-right))] pb-2 h-14"> {/* Revert top padding, keep L/R safe area */}
